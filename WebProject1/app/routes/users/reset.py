...
def get_reset_password_router(
    ...
    async def forgot_password(
        ...
        return JSONResponse(content={"detail": "Password reset link sent"}, status_code= status.HTTP_202_ACCEPTED)
    ...
    async def reset_password(
        ...
        try:
            ...
            return JSONResponse(content={"detail": "Password reset sucessfully"}, status_code= status.HTTP_202_ACCEPTED)            

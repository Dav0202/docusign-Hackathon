...
class Envelope:
	@staticmethod
	def send(request, envelope, session):
		"""Send an envelope
		Parameters:
	...
	@staticmethod
	def get_view(request, envelope_id, envelope_args, data, session, authentication_method='None'):
	...
	@staticmethod
	def list(request, envelope_args, user_documents, session):
	...
	@staticmethod
	def download(request, args, session):
